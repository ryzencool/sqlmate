...
function DBDoc(props) {
    ...
    useEffect(() => {
        if (tableColumns.status === "success") {
            setTableColumnsState(tableColumns.data.data.data)
        }
    }, [
        tableColumnsState, tableColumns
    ])
        ...
        <div className={"flex flex-col gap-5  "}>
            ...
            <div>
                ...
                <div className={"mt-3"}>
                    ...
                    <div>
                        { <ZTable data={tableColumnsState} columns={columns}
